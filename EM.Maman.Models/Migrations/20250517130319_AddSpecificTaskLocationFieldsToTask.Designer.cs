...
namespace EM.Maman.Models.Migrations
{
    ...
    [Migration("20250517130319_AddSpecificTaskLocationFieldsToTask")]
    partial class AddSpecificTaskLocationFieldsToTask
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EM.Maman.Models.LocalDbModels.Task", b =>
                {
                    ...
                    b.Property<long?>("RetrievalDestinationCellId")
                        .HasColumnType("bigint");

                    b.Property<long?>("RetrievalDestinationFingerId")
                        .HasColumnType("bigint");

                    b.Property<long?>("RetrievalSourceCellId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("StorageDestinationCellId")
                        .HasColumnType("bigint");

                    b.Property<long?>("StorageSourceFingerId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("RetrievalDestinationCellId");

                    b.HasIndex("RetrievalDestinationFingerId");

                    b.HasIndex("RetrievalSourceCellId");

                    b.HasIndex("StorageDestinationCellId");

                    b.HasIndex("StorageSourceFingerId");
            ...
            modelBuilder.Entity("EM.Maman.Models.LocalDbModels.Task", b =>
                {
                    ...
                    b.HasOne("EM.Maman.Models.LocalDbModels.Cell", "RetrievalDestinationCell")
                        .WithMany("TasksAsRetrievalDestination")
                        .HasForeignKey("RetrievalDestinationCellId")
                        .HasConstraintName("FK_Task_Cell_RetrievalDestination");

                    b.HasOne("EM.Maman.Models.LocalDbModels.Finger", "RetrievalDestinationFinger")
                        .WithMany("TasksAsRetrievalDestination")
                        .HasForeignKey("RetrievalDestinationFingerId")
                        .HasConstraintName("FK_Task_Finger_RetrievalDestination");

                    b.HasOne("EM.Maman.Models.LocalDbModels.Cell", "RetrievalSourceCell")
                        .WithMany("TasksAsRetrievalSource")
                        .HasForeignKey("RetrievalSourceCellId")
                        .HasConstraintName("FK_Task_Cell_RetrievalSource");

                    b.HasOne("EM.Maman.Models.LocalDbModels.Cell", "StorageDestinationCell")
                        .WithMany("TasksAsStorageDestination")
                        .HasForeignKey("StorageDestinationCellId")
                        .HasConstraintName("FK_Task_Cell_StorageDestination");

                    b.HasOne("EM.Maman.Models.LocalDbModels.Finger", "StorageSourceFinger")
                        .WithMany("TasksAsStorageSource")
                        .HasForeignKey("StorageSourceFingerId")
                    ...
                    b.Navigation("RetrievalDestinationCell");

                    b.Navigation("RetrievalDestinationFinger");

                    b.Navigation("RetrievalSourceCell");

                    b.Navigation("StorageDestinationCell");

                    b.Navigation("StorageSourceFinger");
                });
            ...
            modelBuilder.Entity("EM.Maman.Models.LocalDbModels.Cell", b =>
                {
                    ...
                    b.Navigation("TasksAsRetrievalDestination");

                    b.Navigation("TasksAsRetrievalSource");

                    b.Navigation("TasksAsStorageDestination");
                });
            ...
            modelBuilder.Entity("EM.Maman.Models.LocalDbModels.Finger", b =>
                {
                    ...
                    b.Navigation("TasksAsStorageSource");
                });
